...
const QuoteManagement = () => {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-10">
        <h2 className="text-[#E5E5E5] font-[Inter] font-bold text-[20px] leading-[1.2em] mb-1">Client quote templates</h2>
        <p className="text-[#9CA3AF] font-[Inter] text-sm mb-4">Set terms and conditions per client. Clients generate their own quotes from the equipment portal.</p>
      ...
      <div>
        <h2 className="text-[#E5E5E5] font-[Inter] font-bold text-[20px] leading-[1.2em] mb-1">Quotes received</h2>
        <p className="text-[#9CA3AF] font-[Inter] text-sm mb-4">Quotes generated by clients from the equipment portal.</p>
        <div className="bg-[#1F1F20] border border-[#333333] rounded-lg overflow-hidden">
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#333333]">
