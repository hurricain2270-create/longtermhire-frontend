    ...
    const saveQuote = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                equipment_name: equipment?.equipment_name || equipment?.name || quoteData.equipmentData?.description || "",
                base_price: parseFloat(equipment?.base_price || quoteData.equipmentData?.basePrice || 0),
