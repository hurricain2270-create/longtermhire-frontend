    ...
    const prepareQuoteData = async () => {
        ...
        try {
            ...
            const data = {
                ...
                gst_percentage: quoteConfig.gst_percentage?.toString() || "10",
                terms_of_hire: quoteConfig.terms_of_hire || "Standard Long Term Hire Terms & Conditions apply.",
                quote_id: null, // Generated by backend
    ...
    const saveQuote = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                company_logo: quoteData.company_logo,
                gst_percentage: parseFloat(quoteData.gst_percentage) || 10,
                ...
                equipment_name: quoteData.equipmentData?.description || quoteData.equipmentData?.equipment_name || equipment?.equipment_name || "",
                base_price: quoteData.equipmentData?.basePrice || equipment?.base_price || 0,
