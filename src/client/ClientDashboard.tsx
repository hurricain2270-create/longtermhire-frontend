    ...
    useEffect(() => {
        const loadClientData = async () => {
            try {
                ...
                try {
                    const settings = await clientAuthApi.getCompanySettings();
                    if (settings) {
                        setCompanySettings({
                            ad_text: settings.ad_text || "",
                            ad_text_destination: settings.ad_text_destination || "To Sticky Note",
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <main className="flex-1 px-4 sm:px-8 lg:px-20 pb-[100px] py-6 lg:py-8 lg:max-w-[866px] xl:max-w-full">
                    <div className="max-w-full lg:max-w-[810px]">
                        {/* Ad Space Banner */}
                        {companySettings.ad_text && companySettings.ad_text_destination === "To Ad Space" && (
                            <div className="mb-8 lg:mb-12">
                                <div className="bg-[#1F1F20] border-2 border-[#333333] rounded-lg p-6 text-center">
                                    <div className="text-[#9CA3AF] text-sm mb-2 font-semibold">Ad Space</div>
                                    <div
                        ...
                        >
                            <div className="bg-[#FDE047] border-2 border-[#EAB308] rounded-lg p-6 relative shadow-lg">
                                ...
                                <div
                                    ...
                                    style={{ fontFamily: "'Kalam', 'Caveat', 'Patrick Hand', cursive" }}
                                    dangerouslySetInnerHTML={{
                                        __html: (companySettings.ad_text && companySettings.ad_text_destination === "To Sticky Note")
