          ...
          <div className="grid grid-cols-2 gap-x-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange("year_made", e.target.value)}
                className="w-full h-[46px] bg-[#292A2B] border border-[#333333] rounded-[6px] text-[#E5E5E5] text-[16px] font-[Inter] px-3 outline-none focus:border-[#FDCE06] transition-colors"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-x-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange("previous_code", e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange("waiver_excess", e.target.value)}
                className="w-full h-[46px] bg-[#292A2B] border border-[#333333] rounded-[6px] text-[#E5E5E5] text-[16px] font-[Inter] px-3 outline-none focus:border-[#FDCE06] transition-colors"
              />
            </div>
          </div>
