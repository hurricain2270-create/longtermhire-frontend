...
export function calculateMonthlyPrices(
  ...
  for (let month = 1; month <= durationMonths; month++) {
    ...
    if (month === 1) {
      // Month 1: Apply Initial Discount Only (from the base price)
      ...
      schedule.push({
        month,
        unitPrice: basePrice, // Month 1 Unit Price is the absolute Base Price
      ...
      // Month 3+:
      // Unit Price is Previous Month's Price (Progressive compounding)
