...
const AdminSidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M12.25 0.75H1.75C0.784766 0.75 0 1.53477 0 2.5V12.5C0 13.4652 0.784766 14.25 1.75 14.25H12.25C13.2152 14.25 14 13.4652 14 12.5V2.5C14 1.53477 13.2152 0.75 12.25 0.75ZM12.25 12.5H1.75V2.5H12.25V12.5ZM3.5 4.25H10.5V5.75H3.5V4.25ZM3.5 7.25H10.5V8.75H3.5V7.25ZM3.5 10.25H7V11.75H3.5V10.25Z"
            fill="currentColor"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <circle cx="11" cy="11.75" r="2" stroke="currentColor" strokeWidth="1.2"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M9.4 2.2a3 3 0 0 0-3.9 3.6L2 9.3a1.4 1.4 0 1 0 2 2l3.5-3.5a3 3 0 0 0 3.6-3.9L9.7 5.6 8 5.3 7.7 3.6l1.7-1.4Z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/>
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      icon: (
        <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4.75 6.25a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM10.5 7.5a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5Z"
            stroke="currentColor" strokeWidth="1.3" />
          <path d="M1 12.75c0-1.8 1.68-3.25 3.75-3.25s3.75 1.45 3.75 3.25M9.25 9.9c1.6.25 2.75 1.4 2.75 2.85"
  ...
  return (
    <>
      ...
      >
        {/* Logo section */}
        <div className="flex items-center justify-center border-b border-[#333333] h-24 px-4">
          <img
            src={companyLogo || "/figma-assets/logo.svg"}
            alt="Company Logo"
            className="h-[80px]"
          />
        </div>
